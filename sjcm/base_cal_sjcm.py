...
data = katfile.open('1314375234.h5', channel_range=(200, 800))
...
#
diff_delay_errs = np.sqrt(diff_delay_errs);
diff_delay_errs[:] = 1;
...
data_bunch = (ants, input_pairs, time_vec, target_list, time_lim, ant_ref, diff_delays, diff_delay_errs);

aa = sc.optimize.leastsq(chi_sq_w, initial_locs, data_bunch);
